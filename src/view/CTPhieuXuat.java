...
public class CTPhieuXuat extends javax.swing.JDialog {
    ...
    public CTPhieuXuat(javax.swing.JInternalFrame parent, javax.swing.JFrame owner, boolean modal) {
        ...
        KhachHang kh = pn.getKhachHang();
        if (kh != null) {
            labelTenKH.setText(kh.getTenKH());
            labelSDT.setText(kh.getSdtKH());
        } else {
            labelTenKH.setText("Không có thông tin");
            labelSDT.setText("");
        }
    ...
    try {
        ArrayList<ChiTietPhieu> CTPhieu = ChiTietPhieuXuatDAO.getInstance()
            .selectAll(this.parent.getPhieuXuatSelect().getMaPhieu());
        DefaultTableModel tblCTPhieumd = (DefaultTableModel) tblChiTietPhieu.getModel();
        tblCTPhieumd.setRowCount(0);
        for (int i = 0; i < CTPhieu.size(); i++) {
            double giaXuat = CTPhieu.get(i).getDonGia() * 1.1;
            ...
            tblCTPhieumd.addRow(new Object[]{
                ...
                soLuong,
                parent.getFormatter().format(giaXuat) + "đ",                      // ✅ đơn giá đã nhân 1.1
                parent.getFormatter().format(giaXuat * soLuong) + "đ"            // ✅ tổng tiền đã đúng
            });
        }
    } catch (Exception e) {
        e.printStackTrace(); // nên in log để dễ debug
    }
}
    ...
    private void initComponents() {
        ...
        labelTenKH.setText("jLabel7");

        jLabel8.setText("Số điện thoại:");

        labelSDT.setText("jLabel7");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(labelTenKH, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jLabel8, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(labelSDT, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
