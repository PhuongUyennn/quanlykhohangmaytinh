...
public class UpdateKhachHang extends javax.swing.JDialog {
    ...
    private void displayInfo() {
        KhachHang a = parent.getKhachHangSelect();
        txtMaKhachHang.setText(a.getMaKH());
        txtdiaChi.setText(a.getDiaChi());
        txtTenKhachHang.setText(a.getTenKH());
        txtphone1.setText(a.getSdtKH());
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            ncc.setMaKH(txtMaKhachHang.getText());
            ncc.setTenKH(txtTenKhachHang.getText());
            ncc.setSdtKH(txtphone1.getText());
            ncc.setDiaChi(txtdiaChi.getText());
            KhachHangDAO nccDao = new KhachHangDAO();
            nccDao.update(ncc);
            this.dispose();
